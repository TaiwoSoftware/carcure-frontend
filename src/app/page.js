              ...
              content={
                <>
                  ...
                  <p className="text-white mt-4 font-normal">
                    ...
                    troubles. That&#39;s why we&#39;ve created an app that puts
                    the power of expert mechanics right at your fingertips.
                    Whether you&#39;re stranded on the roadside or need routine
                    maintenance, Car Cure has you covered.
                  </p>
                </>
              }
            />
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="bg-[#ffffff1c] p-8 rounded-md h-[17rem] mt-6">
                      ...
                      <p className="text-white text-center">
                        ...
                        just a tap away. Our network of certified mechanics is
                    ...
                    <div className="bg-[#ffffff1c] p-8 rounded-md h-[17rem] mt-6">
                      ...
                      <p className="text-white text-center">
                        ...
                        Say goodbye to hidden fees. Get upfront pricing
                        estimates for your repair or service before any work
                        begins, ensuring transparency and trust.
                      </p>
                    </div>
                    <div className="bg-[#ffffff1c] p-8 rounded-md h-[17rem] mt-6">
                      <div className="bg-[#fff] p-10 mb-4 "></div>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="bg-[#ffffff1c] p-8 rounded-md h-[17rem] mt-6">
                      ...
                      <p className="text-white text-center">
                        ...
                        Flat tire? Dead battery? We&#39;ll get you moving again.
                        Routine Maintenance: From oil changes to brake checks,
                    ...
                    <div className="bg-[#ffffff1c] p-8 rounded-md h-[17rem] mt-6">
                      ...
                      <p className="text-white text-center">
                        ...
                        Unsure what&#39;s wrong? Our mechanics will diagnose the
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="bg-[#ffffff1c] p-8 rounded-md h-[17rem] mt-6">
                      ...
                      <p className="text-white text-center">
                        ...
                        Simply open the Car Cure app and describe your car issue
                        or service needs.
                      </p>
                    </div>
                    <div className="bg-[#ffffff1c] p-8 rounded-md h-[17rem] mt-6">
                      ...
                      <p className="text-white text-center">
                        ...
                        Get instant quotes from nearby mechanics along with
                        their availability.
                      </p>
                    </div>
                    <div className="bg-[#ffffff1c] p-8 rounded-md h-[17rem] mt-6">
